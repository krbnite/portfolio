...
## Drive Form Features
email.send_keys("kevin.urban@wwecorp.com")
password.send_keys("th3JWM2n!")
submit_button.click()

# Do Stuff
## Currently, a warning message appears stating that WWE
## need to pay up.  This is how you "x it out"
driver.switch_to_active_element().click()

## We're signed in, so technically we can just use links
## instead of figuring out clicks..
## -- go to Content page
